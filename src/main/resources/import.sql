...
insert into users(user_id,email,first_name,last_name,number,street,zip_code) values (1,'cisse09@gmail.com','Djibril','Cisse',3,'Patission','12321');
insert into users(user_id,email,first_name,last_name,number,street,zip_code) values (2,'kennun@aueb.gr','Kendrick','Nunn',3,'Kifisias','12333');
insert into users(user_id,email,first_name,last_name,number,street,zip_code) values (3,'kosloy@gmail.com','Kostas','Sloukas',3,'Vouliagmenis','12334');
